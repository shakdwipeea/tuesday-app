...
class EditProfileAdapter
    ...
    protected void onBindItemViewHolder(ProfileItemViewHolder holder, int section, int indexPosition) {
        ...
        if (section == SECTION_CALL &&
                (!TextUtils.isEmpty(provider.providerDetails.detailType)) &&
        ...
        } else if (TextUtils.isEmpty(provider.providerDetails.description)) {
            FirebaseCrash.log("Provider -> " + provider);
        }
